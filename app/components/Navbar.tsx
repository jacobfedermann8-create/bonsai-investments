...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-[#0B0D0F]/80 backdrop-blur-xl border-b border-white/10">
      ...
      <div className="max-w-[1400px] mx-auto px-10 py-5 flex items-center justify-between">
        ...
        {/* Menu */}
        <div className="hidden xl:flex items-center gap-10 ml-10 text-[14px] tracking-wide text-gray-300">
        ...
        <div className="flex items-center gap-5 ml-8">
          ...
          <Link
            href="/contact"
            className="bg-[#C6A15B] text-black px-6 py-3 rounded-full text-sm font-medium hover:opacity-90 transition"
          >
            Contact
          </Link>
